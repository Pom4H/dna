...
import { baseline as funded, growth, latePayment } from "./cashflow.ts";

for (const scenario of [baseline, downside, breakEven, firmware, operator, noData, empty, synthetic, funded, growth, latePayment]) {
